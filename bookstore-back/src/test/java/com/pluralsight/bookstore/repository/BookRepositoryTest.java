...
import com.pluralsight.bookstore.util.NumberGeneration;
...
public class BookRepositoryTest {
    ...
    public static Archive<?> createDeploymentPackage() {
        ...
        return ShrinkWrap.create(JavaArchive.class)
            ...
            .addClass(NumberGeneration.class)
    ...
    public void shouldCreateABook() {
        // Creates a book
        Book book = new Book("isbn", "Harry  Potter", 12F, 123, Language.ENGLISH, new Date(), "imageURL", "description");
        book = bookRepository.create(book);
    ...
    public void shouldFindTheCreatedBook() {
        ...
        assertEquals("Harry Potter", bookFound.getTitle());
